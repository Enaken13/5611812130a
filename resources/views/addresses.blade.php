                                ...
                                <form action="{{ url('/') }}" method="POST">
                                    ...
                                    <div class="field">
                                        ...
                                        <select name="city" class="vl_empty">
                                            ...
                                            <option value="Kyev">Kyev</option>
                                        </select>
                                    </div>
                                    <div class="field">
                                        <label>Your area *</label>
                                        <select name="area">
                                            <option nameclass="plh"></option>
                                            <option>Saltovka</option>
                                    ...
                                    <div class="field">
                                        ...
                                        <textarea name="information" value="  "></textarea>
                                    </div>
                            ...
                            <div class="r_col">
                                ...
                                <div class="uo_adr_list">
                                    <div class="item">
                                        ...
                                        <form action="{{ url('/'.$address->id) }}" method="POST">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}

                                            <button style="border:1px transparent; background-color: transparent" type="submit" class="actbox">
                                                <i class="bcross"></i>
                                            </button>
                                        </form>
